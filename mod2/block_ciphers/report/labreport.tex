...
\verb|(.venv) python task1.py|

% ============================================================================
\section*{Task 3: Performance Comparison}
\subsection*{Abstract}

% TODO: talk about the point of this task

\subsection*{Code Breakdown}
% TODO: talk about what the code is doing 
% TODO: insert the code from task3.py
\begin{framed}
\begin{verbatim}
\end{verbatim}
\end{framed}
...
Running this test is as simple as activating the venv, and then running \verb|task3.py|. 
